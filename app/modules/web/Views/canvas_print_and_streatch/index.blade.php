...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{{ URL::asset('canvas_print_and_streatch/static/css/libraries.min.css') }}"/>
  <link rel="stylesheet" type="text/css" href="{{ URL::asset('canvas_print_and_streatch/static/css/offthewall-common.min.css') }}"/>
  <link rel="stylesheet" type="text/css" href="{{ URL::asset('web/photo_frame/static/css/custom.css') }}">  
  <script src="{{ URL::asset('canvas_print_and_streatch/static/js/libraries.min.js') }}"></script>
</head>
<body>
       ...
       <div class="col-sm-11 col-sm-offset-1">
          <div class="row">
              <ul class="main-menu">
                  ...
                  <li>
                      <a class="active" href="{{URL::to('')}}/canvas-print-and-streatch">Canvas Print and Stretch</a>
                  </li>                        
          ...
          <div class="col-xs-12 col-sm-10 center-block" id="bg-wrapper">
            <div class="offtwl_d">
              <div class="page-title">
                <h1 class="primary-title">CANVAS PRINTING AND STRETCHING</h1>
            ...
            <div class="row">
              <div class="col-xs-12 col-sm-6 left-side-bar">
                <p id="offtwl_static_preview" class="text-center"><span id="loading"
                            ...
                            src="{{URL::to('')}}/canvas_print_and_streatch/static/images/loading.gif"/></span>
                  <img
              ...
              <div class="col-xs-12 col-sm-6">
                <div id="offtwl_upload-canvas-holder">
                  ...
                  <div class="right-side-bar">
                    ...
                    <form name="offtwl_userupload-form" action="/index.php" method="post" enctype="multipart/form-data">
                      ...
                      <h3 style="margin-top: 0;">Upload your photo</h3>
                    ...
                    <div>
                      <p>
                        Customise a canvas print of your favourite image or photograph. Vibrant colours, quality materials and professional workmanship means your custom canvas print will be attractive for many years to come. Your canvas will be printed and stretched and you will receive it ready to hang.
                      </p>
                      <p>
                        Upload your image and choose your canvas dimensions. Once we receive your order we will test your image to make sure it is high enough resolution to produce a quality print at your chosen size. 
                      </p>
                      <p>
