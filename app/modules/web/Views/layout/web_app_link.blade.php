<div style="position: absolute;top: 5%;z-index: 99999;right: 5%;    background: rgba(255,255,255,.5);padding: 15px 15px 20px 15px;">
    ...
    <a href="{{URL::to('')}}/custom-picture-frame" style="color: #fff;
        font-size: 12px;background: #018b8d;padding: 10px 42px;
