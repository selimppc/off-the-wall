...
function () {
  ...
  Darkroom.prototype = {
    ...
    _popTransformation: function (transformations) {
      if (0 === transformations.length) return this.dispatchEvent('core:reinitialized'),
      this.refresh(),
      void 0;
    ...
    _initializeDOM: function (imageElement) {
      ...
      mainContainerElement.className = 'darkroom-container row';
      var toolbarElement = document.createElement('div');
      toolbarElement.className = 'darkroom-toolbar col-lg-1 col-md-1 col-sm-1',
      mainContainerElement.appendChild(toolbarElement);
      var canvasContainerElement = document.createElement('div');
      canvasContainerElement.className = 'darkroom-image-container col-lg-11 col-md-11 col-sm-11';
...
function () {
  ...
  CropZone = fabric.util.createClass(fabric.Rect, {
    _render: function (ctx) {
      ...
      void 0 !== ctx.setLineDash ? ctx.setLineDash([dashWidth,
      dashWidth])  : void 0 !== ctx.mozDash && (ctx.mozDash = [
        dashWidth,
        dashWidth
      ]),
