...
function CanvasFrameImage(elem) {
    ...
    this.drawSlipImage = function (frame) {
        ...
        FRAME_IMAGE.onload = function () {
            ...
            ctx.fillRect(FRAME_IMAGE.height, 0, ctxScaleWidth - FRAME_IMAGE.height, FRAME_IMAGE.height);
            ctx.restore();
            ...
            ctx.scale(ctxScale, ctxScale);
            ctx.beginPath();
            ctx.translate(ctxScaleWidth, ctxScaleHeight - FRAME_IMAGE.height);
            ctx.rotate(180 * PIRAD);
            ctx.moveTo(0, 0);
            ctx.fillRect(0, 0, ctxScaleWidth - FRAME_IMAGE.height, FRAME_IMAGE.height);
            ctx.rotate(180 * PIRAD);
            ctx.restore();
            ...
            ctx.save();
            ctx.scale(ctxScale, ctxScale);
            ctx.translate(FRAME_IMAGE.height, ctxScaleHeight - FRAME_IMAGE.height);
            ctx.rotate(-90 * PIRAD);
