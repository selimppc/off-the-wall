                                ...
                                @foreach($data as $values)
                                    <tr class="gradeX">
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('order-paid-deliverd', $values->id) }}" class="btn btn-info btn-xs" onclick="return confirm('Are you sure to Delivered?')" title="Delivered"><i class="icon-exclamation"></i></a>
