	...
	<div id="print_verification_letter">
		...
		<table border="0" cellspacing="0" cellpadding="0" style="font-size:14px;width:100%;font-family:'arial';color:#000;line-height:20px;">
			...
			<thead>
				...
				<tr>
					<th style="border-bottom: 2px solid #ddd;padding:5px;text-align: left; ">Mirror Size</th>
					<th style="border-bottom: 2px solid #ddd;padding:5px;text-align: left; ">Frame</th>	
					<th style="border-bottom: 2px solid #ddd;padding:5px;text-align: left; ">Backing</th>							
					<th style="border-bottom: 2px solid #ddd;padding:5px;text-align: left; ">Quantity</th>
					<th style="border-bottom: 2px solid #ddd;padding:5px;text-align: right; ">Frame Price</th>
					<th style="border-bottom: 2px solid #ddd;padding:5px;text-align: right; ">Backing Price</th>
					<th style="border-bottom: 2px solid #ddd;padding:5px;text-align: right; ">Mirror Price</th>
