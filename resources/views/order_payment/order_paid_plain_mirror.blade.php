                            ...
                            @if(isset($data))
                                @foreach($data as $values)
                                    <tr class="gradeX">
                                        ...
                                        <td>{{$values->status}}</td>
                                        <td>
                                            <a href="{{ route('order-paid-show-plain-mirror', $values->id) }}" data-toggle="modal" data-target="#etsbModal" class="btn btn-info btn-xs" title="Details"><i class="icon-eye-open"></i></a>
