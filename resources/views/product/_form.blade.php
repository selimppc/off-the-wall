...
<div class="col-md-6">
    <div class="row">
        ...
        <div class="form-group">
            ...
            <small class="required">(Required)</small>
            {!! Form::number('sell_rate', null, ['id'=>'sell_rate', 'class' => 'form-control','required']) !!}
        </div>

        <div class="form-group">
            {!! Form::label('Delivered Price', 'Delivered Price:', ['class' => 'control-label']) !!}
            {!! Form::number('cost_price', null, ['id'=>'cost_price', 'class' => 'form-control']) !!}
        </div>
        

        <div class="form-group">
            {!! Form::label('Before Price', 'Before Price:', ['class' => 'control-label']) !!}
            {!! Form::number('before_price', null, ['id'=>'before_price', 'class' => 'form-control']) !!}
        </div>
